    ...
    <section className="bg-[#030712] w-full">
      ...
      <div className="flex flex-col">
        ...
        <p className="text-[#A684FF] text-base sm:text-2xl mt-5 font-normal">
          Anchor tag ka matlab hota hai "anchor tag". Ye HTML ka ek element hai
          jo kisi link ko define karta hai. Iska use hum kisi aur page, website,
          ya document pe jump karne ke liye karte hain.
        </p>
        <h2 className="text-2xl sm:text-4xl font-normal mt-5 text-white">2. Attributes</h2>
        <div className="text-white font-normal text-lg sm:text-2xl mt-5 flex flex-col gap-3">
          ...
          <li>
            Target :-
            <span className="text-[#00BCFF]">
              target attribute anchor tag ke andar use hota hai ye decide karne
              ke liye ki link pe click karne ke baad naya page kahan open hoga.
            </span>
          </li>
          <p>Types of target </p>
          <p>
